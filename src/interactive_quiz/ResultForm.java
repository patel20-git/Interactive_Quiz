...
public class ResultForm extends javax.swing.JFrame {
    ...
    public ResultForm(User user) {
        ...
        ResultSet rs;
        String query="SELECT * FROM quiz q INNER JOIN category c ON c.category_id = q.category_id WHERE userId= ?";
        DefaultListModel<Item> quiz = new DefaultListModel<Item>();
            ...
            try {
                ...
                while(rs.next())
                {
                    String name = rs.getString("name")+" Quiz "+rs.getInt("quiz_id");
                    Item item = new Item(rs.getInt("quiz_id"),""+name);
                    quiz.addElement(item);
                   
                }
                 jList1.setModel(quiz);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select the Quiz to check result");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ResultDetailedForm form = new ResultDetailedForm(id, Qname, user);
        form.setVisible(true);
        form.pack();
        form.setLocationRelativeTo(null);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultForm(user).setVisible(true);
            }
        });
    }
